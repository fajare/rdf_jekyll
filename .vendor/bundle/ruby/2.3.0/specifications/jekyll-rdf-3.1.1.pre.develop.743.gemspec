# -*- encoding: utf-8 -*-
# stub: jekyll-rdf 3.1.1.pre.develop.743 ruby lib

Gem::Specification.new do |s|
  s.name = "jekyll-rdf".freeze
  s.version = "3.1.1.pre.develop.743"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sparql-client>.freeze, [">= 3.0.1", "~> 3.0"])
      s.add_runtime_dependency(%q<jekyll>.freeze, [">= 3.1"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.4"])
      s.add_development_dependency(%q<rest-client>.freeze, [">= 2.0.1", "~> 2.0"])
      ...
      s.add_dependency(%q<sparql-client>.freeze, [">= 3.0.1", "~> 3.0"])
      s.add_dependency(%q<jekyll>.freeze, [">= 3.1"])
      s.add_dependency(%q<rake>.freeze, ["~> 10.4"])
      s.add_dependency(%q<rest-client>.freeze, [">= 2.0.1", "~> 2.0"])
