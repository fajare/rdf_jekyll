...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rdf-isomorphic>.freeze, ["< 4.0", ">= 2.0"])
      s.add_runtime_dependency(%q<rdf-json>.freeze, ["< 4.0", ">= 2.0"])
      s.add_runtime_dependency(%q<rdf-microdata>.freeze, ["< 4.0", ">= 2.2"])
      s.add_runtime_dependency(%q<rdf-n3>.freeze, ["< 4.0", ">= 2.1"])
      s.add_runtime_dependency(%q<rdf-normalize>.freeze, ["~> 0.3"])
      s.add_runtime_dependency(%q<rdf-rdfa>.freeze, ["< 4.0", ">= 2.2"])
      s.add_runtime_dependency(%q<rdf-rdfxml>.freeze, ["< 4.0", ">= 2.2"])
      s.add_runtime_dependency(%q<rdf-reasoner>.freeze, ["~> 0.4"])
      s.add_runtime_dependency(%q<rdf-tabular>.freeze, ["< 4.0", ">= 2.2"])
      s.add_runtime_dependency(%q<rdf-trig>.freeze, ["< 4.0", ">= 2.0"])
      s.add_runtime_dependency(%q<rdf-trix>.freeze, ["< 4.0", ">= 2.2"])
      ...
      s.add_dependency(%q<rdf-json>.freeze, ["< 4.0", ">= 2.0"])
      s.add_dependency(%q<rdf-microdata>.freeze, ["< 4.0", ">= 2.2"])
      s.add_dependency(%q<rdf-n3>.freeze, ["< 4.0", ">= 2.1"])
      ...
      s.add_dependency(%q<rdf-trig>.freeze, ["< 4.0", ">= 2.0"])
      s.add_dependency(%q<rdf-trix>.freeze, ["< 4.0", ">= 2.2"])
